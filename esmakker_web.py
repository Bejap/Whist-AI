...
class EsmakkerWebGame:
    ...
    def new_game(self):
        ...
        self.game.bid(0, "9")
        self.game.active_bidders = {0}
        self.game.phase = "choose_trump"
        self.history = []
        self.done = False
        self.message = "Choose trump for your 9 contract."
    ...
    def state(self):
        ...
        return {
            ...
            "trick": [{"player": p, "card": c, "name": card_name(c)} for p, c in self.game.trick_cards],
